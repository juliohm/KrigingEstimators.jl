@testset "Solvers" begin
  ...
  @testset "Kriging1D" begin
    ...
    if visualtests
      ...
      for i in 1:3
        ...
        @test_reference "data/$(sname)1D.png" plot(solution)
      end
    end
  end
  ...
  @testset "GlobalKriging2D" begin
    ...
    if visualtests
      gr(size=(800,400))
      @test_reference "data/GlobalKriging2D.png" contourf(solution)
    end
  end
  ...
  @testset "NearestKriging2D" begin
    ...
    if visualtests
      gr(size=(800,400))
      @test_reference "data/NearestKriging2D.png" contourf(solution)
    end
  end
  ...
  @testset "LocalKriging2D" begin
    ...
    if visualtests
      gr(size=(800,400))
      @test_reference "data/LocalKriging2D.png" contourf(solution)
    end
  end
end
